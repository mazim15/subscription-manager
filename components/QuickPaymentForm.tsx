    ...
    <form onSubmit={handleSubmit} className="mt-3 bg-gray-800/30 p-3 rounded-lg">
      <div className="flex flex-col space-y-2">
        ...
        <input
          ...
          className="w-full bg-gray-800 text-white border border-gray-700 rounded-md px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all duration-200"
